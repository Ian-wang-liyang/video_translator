...
def settings_fingerprint(settings: Settings) -> str:
    material = "|".join(
        [settings.transcription_backend, settings.translation_backend, settings.device,
         ...
         str(settings.source_chunk_overlap_seconds), str(settings.window_overlap_seconds),
         str(settings.vad_threshold), str(settings.foreground_min_dbfs),
         str(settings.foreground_confident_min_dbfs),
         str(settings.foreground_confident_logprob),
         str(settings.foreground_confident_no_speech_prob),
         str(settings.rescue_activity_dbfs), str(settings.rescue_flag_logprob),
         str(settings.rescue_accept_logprob),
         str(settings.rescue_agreement_threshold),
         str(settings.rescue_conditional_agreement_threshold),
         str(settings.translation_context_cues), str(settings.translation_review_enabled),
         str(settings.translation_review_min_length_ratio),
         str(settings.translation_review_max_length_ratio), str(settings.translation_n_ctx),
